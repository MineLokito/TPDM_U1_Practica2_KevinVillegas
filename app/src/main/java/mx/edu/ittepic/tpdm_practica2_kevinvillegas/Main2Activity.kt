...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        valor=findViewById(R.id.editaValor)
        grid=findViewById(R.id.layogrid)
        a1=findViewById(R.id.rbtnA1)
        a2=findViewById(R.id.rbtnA2)
        a3=findViewById(R.id.rbtnA3)
    ...
    fun guardarA1(){
        cadena="V"+editPosicionC.text.toString()+" /nValor: "+valor?.text.toString()
        if(m==1){cadena= "Titulo: "+"M"+editPosicionC.text.toString()+editPR?.text.toString()+" /nValor: "+valor?.text.toString()}
